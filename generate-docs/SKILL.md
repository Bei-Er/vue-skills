...
description: 当需要为 Vue 项目一次性生成全部文档（组件、路由、Store、工具方法）并更新侧边栏时使用。内部依次调用四个文档 skill，最后统一更新侧边栏。
---
...
一次性调用四个文档 skill 为 Vue 项目生成全部文档，完成后统一更新 docsify 侧边栏。
...
4. `vue-skills:utils-docs` — 工具方法文档

**规则：**
- 全部生成时，四个 skill 按顺序全部调用
